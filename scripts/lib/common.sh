...
DOCKMASTER_K3S_VERSION="${DOCKMASTER_K3S_VERSION:-v1.36.2+k3s1}"
DOCKMASTER_K3S_INSTALL_SCRIPT_SHA256="${DOCKMASTER_K3S_INSTALL_SCRIPT_SHA256:-46177d4c99440b4c0311b67233823a8e8a2fc09693f6c89af1a7161e152fbfad}"
